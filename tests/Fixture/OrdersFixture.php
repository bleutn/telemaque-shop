...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'orders_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'orders_ibfk_1' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['orderstatus', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'status_id' => 1,
            'order_date' => '2015-09-09 13:08:38',
            'created' => '2015-09-09 13:08:38',
            'modified' => '2015-09-09 13:08:38'
        ],
    ];
}
